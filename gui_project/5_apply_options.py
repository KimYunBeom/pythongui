...
# 파일 추가
def add_file():
  files = filedialog.askopenfilenames(title='이미지 파일을 선택하세요', filetypes=( ('JPG 파일', '*.jpg'), ('PNG 파일', '*.png'), ('BMP 파일', '*.bmp'), ('모든 파일', '*.*') ), initialdir=r'c:\data\dev\workspace3\pythongui\gui_project\images') # 최초의 사용자가 지정한 경로를 보여줌
